...
export default async function About() {
  ...
  return (
    <>
      <PageIntro eyebrow="Мастера" title="Наши массажистки">
        <p>
      ...
      <Container className="mt-16">
        <StatList>
          <StatListItem value="35" label="Всего мастеров" />
          <StatListItem value="8" label="Ежедневно смене" />
          <StatListItem value="24/7" label="Доступны" />
        </StatList>
      </Container>
